...
const Navbar = () => {
  ...
  return (
    <div className="font-montserrat h-16 md:h-20 text-[#983820] p-4 flex items-center justify-between border-b-2 border-[#983820] bg-transparent uppercase md:24 lg:px-20 xl:px-40">
      {/* LEFT LINK */}
