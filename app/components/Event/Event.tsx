...
const course = [
  ...
  {
    id: 3,
    title: "Madura Culture",
    chapter: "05 November 2023",
    duration: "Jl. Tunjungan, Kec. Tegalsari, Surabaya, Jawa Timur",
    url: "/kerapan.jpeg",
  },
]
              ...
              <div className="bg-slate-50 w-full rounded-b-3xl mt-[200px] pb-2 font-montserrat flex flex-col">
                <div className="font-montserrat px-3 pt-4 text-[#983820] flex flex-col">
                  ...
                  <div className="flex items-center text-sm font-medium">
                    ...
                    <p className="pt-3 font-medium pb-2 pl-2">
                      {video.chapter}
                    </p>
                  </div>
